...
<!-- /TinyMCE -->';
    ...
    $mpb_tray_conteudo->addElement(new XoopsFormLabel("<a href='javascript:trocaEditor(\"mpb_35_conteudo\")' style='float:right; padding:3px; color:#000000; background-color:#F0F0EE; border: 1px solid #CCCCCC; border-top:0px; margin-top:-1px'>".MPU_ADM_TOGGLE_EDITOR."</a>", $mpu_classe->PegaSmileys()));
}
...
$mpb_tray_conteudo->addElement(new XoopsFormText(MPU_ADM_MPB_EXTERNAL_URL, 'mpb_30_arquivo_external', 30, 255, ((substr($mpu_classe->getVar("mpb_30_arquivo"), 0, 4) == 'ext:') ? substr($mpu_classe->getVar("mpb_30_arquivo"), 4) : 'http://')));
$mpb_tray_conteudo->addElement(new XoopsFormLabel("", "</span>"));
