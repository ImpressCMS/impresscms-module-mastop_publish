...
define("MPU_MOD_BLOCO3", "برای اطلاعات بیشتر به صفحات زیر نیز سری بزنید");
...
define("MPU_MOD_WYSIWYG", "استفاده از یک ویرایشگر بصری برای ساخت صفحات؟");
define("MPU_MOD_WYSIWYG_DESC", "با یک ویرایشگر بصر شما میتوانید به سادگی صفحات HTML ابتکاری خود را بسازید, بدون هیچ دانش برنامه نویسی.");
define("MPU_MOD_WYSIWYG_PATH", "مسیر ویرایشگر");
define("MPU_MOD_WYSIWYG_BT1B", "دکمه های  ویرایشگر- شروع خط ۱");
define("MPU_MOD_WYSIWYG_BT1B_DESC", "دکمه های که در ابتدای خط اول در ویرایشگر نمایش داده میشود");
define("MPU_MOD_WYSIWYG_BT1", "دکمه های  ویرایشگر- انتهای خط ۱");
define("MPU_MOD_WYSIWYG_BT1_DESC", "دکمه های که در انتهای خط اول در ویرایشگر نمایش داده میشود");
define("MPU_MOD_WYSIWYG_BT2B", "دکمه های ویرایشگر - شروع خط ۲");
define("MPU_MOD_WYSIWYG_BT2B_DESC", "دکمه های که در ابتدای خط دوم در ویرایشگر نمایش داده میشود");
define("MPU_MOD_WYSIWYG_BT2", "دکمه های ویرایشگر - انتهای خط ۲");
define("MPU_MOD_WYSIWYG_BT2_DESC", "دکمه های که در انتهای خط دوم در ویرایشگر نمایش داده میشود.");
define("MPU_MOD_WYSIWYG_BT3B", "دکمه های ویرایشگر  - شروع خط۳");
define("MPU_MOD_WYSIWYG_BT3B_DESC", "دکمه های که در ابتدای خط سوم در ویرایشگر نمایش داده میشود");
define("MPU_MOD_WYSIWYG_BT3", "دکمه های ویرایشگر- انتهای خط ۳");
define("MPU_MOD_WYSIWYG_BT3_DESC", "دکمه های که در انتهای خط سوم در ویرایشگر نمایش داده میشود");
define("MPU_MOD_WYSIWYG_BT4", "دکمه های ویرایشگر - خط ۴");
define("MPU_MOD_WYSIWYG_BT4_DESC", "دکمه های که در خط چهارم ویرایشگر نمایش داده میشود.");
define("MPU_MOD_WYSIWYG_PLUGINS", "پلاگین های ویرایشگر");
define("MPU_MOD_WYSIWYG_PLUGINS_DESC", "پلاگین های را که در ویرایشگر استفاده میکنید وارد کنید(به وسیله ی کاما',' از هم جدا کنید )");
define("MPU_MOD_WYSIWYG_PATH_DESC", "مسیری را که TinyMCE در ریشه ی سایت شما قرار دارد وارد کنید (در انتها  فاصله  نگذارید).");
define("MPU_MOD_WYSIWYG_LANG", "زبان پیش فرض برای ویرایشگر");
define("MPU_MOD_WYSIWYG_LANG_DESC", "زبان ویرایشگر را وارد کنید (Ex.: en). برای دانلود  فایل های زبان, <a href='http://tinymce.moxiecode.com/language.php' target='_blank'>کیلیک کنید</a>.");
define("MPU_MOD_NOMES_ID", "استفاده از متن به جای شماره شناسه در آدرس؟");
define("MPU_MOD_NOMES_ID_DESC", "با انتخاب بله متن منو به جای شماره شناسه در آدرس محتوایت استفاده میشود. سیستم قبول میکند که از حالت پیش فرض برای لود صفحات استفاده کن. این تنظیم فقط یک افکت در سیستم شما تولید میکند.");
...
define("MPU_MOD_GZIP", "استفاده از بسته هایGZIP در ویرایشگر؟");
define("MPU_MOD_GZIP_DESC", "اگر سرور شما از بسته هایGZIP پشتیبانی میکند, این گزینه بسته های جاوا اسکیرپ را بسته بندی میکند ( بهGZIP) و امکان لود سریعتر ویرایشگر را فراهم میکند.<br /><b>اخطار:</b> در نتیجه وقتی این قابلیت میتواند صحیح کار کند, که شاخه ی اصلی ویرایشگر (در بالا تعریف کنید, پیکر بندی پارامتر های '".MPU_MOD_WYSIWYG_PATH."')  قابل نوشتن باشد !");
...
define("MPU_MOD_WYSIWYG_FRMTDATA", "فرمت تاریخ  ویرایشگر");
define("MPU_MOD_WYSIWYG_FRMTDATA_DESC", "<b>%d</b> برای روز , <b>%m</b> برای ماه'  <b>%Y</b> برای سال");
define("MPU_MOD_WYSIWYG_FRMTHORA", "فرمت زمان ویرایشگر");
...
define("MPU_MOD_RELATED", "نمایش لینک موضوعات مرتبط در پایان هر صفحه؟");
define("MPU_MOD_RELATED_DESC", "این گزینه به شما اجازه می دهد که به صفحاتی که در یک شاخه قرار دارند لینک بدهید. <br />چنانچه از بلاک موضوعات مرتبط استفاده می کنید، می توانید این گزینه را غیر فعال کنید");
define("MPU_MOD_NAVIGATION", "نمایش نوار ناوبری در بالای هر صفحه؟");
...
define("MPU_MOD_HIGHLIGHT_SEARCH", "<b style='color: red'>موارد جستجو شده زیر رنگ بندی شده اند:</b> ");
...
define("MPU_MOD_CANEDIT_DESC", "با انتخاب بله سازنده صفحه میتواند صفحه خود را   ویرایش کند (این گزینه شامل گروه مدیران/گردانندگان ها نمیشود).");
define("MPU_MOD_CANCREATE", "آیا  مولف ها میتواند زیر صفحه بسازند؟");
define("MPU_MOD_CANCREATE_DESC", "با انتخاب بله سازنده صفحه میتواند   زیر صفحه به صفحه خود اضافه کند (این گزینه شامل گروه مدیران/گردانندگان ها نمیشود).");
define("MPU_MOD_CANDELETE", "آیا  مولف ها میتوانند صفحه خود را حذف کنند؟");
define("MPU_MOD_CANDELETE_DESC", "با انتخاب بله سازنده صفحه میتواند صفحه خود را   حذف کند(این گزینه شامل گروه مدیران/گردانندگان ها نمیشود).");
...
define("MPU_MOD_HOME_ID", "شماره شناسه اصلی صفحه");
define("MPU_MOD_HOME_ID_DESC", "شماره شناسه صفحه ای را که میخواهید  موقع ورود ماژول کاربران به آن صفحه منتقل شوند ( صفحه اول ماژول) انتخاب کنید. اگر این مقدار را خالی بگذارید آخرین صفحه به عنوان صفحه اصلی نمایش داده میشود..");
?>